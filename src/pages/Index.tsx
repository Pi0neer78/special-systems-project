      ...
      <section className="relative flex-1 flex items-center justify-center py-32 overflow-hidden grid-bg">
        ...
        <div className="container relative text-center max-w-3xl mx-auto">
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-4 gap-4 animate-fade-in">
            {services.map((s) => (
              ...
              >
                ...
                <div className="font-display text-sm uppercase tracking-wide">{s.title}</div>
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in">
            <Button
              size="lg"
              className="bg-primary text-primary-foreground hover:bg-primary/90 h-12 px-8 w-full sm:w-auto gap-2"
      ...
      <section id="about" className="border-t border-border/60 py-20">
        <div className="container grid md:grid-cols-3 gap-10">
          <div className="md:col-span-2">
            <span className="font-mono text-sm text-primary uppercase tracking-widest">/ О компании</span>
            <h2 className="font-display text-3xl md:text-4xl font-700 uppercase mt-3 mb-5">СпецСистемы</h2>
          ...
          <div className="space-y-4">
            {[
              ...
              <div key={s.l} className="flex items-center gap-4 p-4 rounded-xl bg-card border border-border">
